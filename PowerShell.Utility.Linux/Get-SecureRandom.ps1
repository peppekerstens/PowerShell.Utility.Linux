...
[CmdletBinding(DefaultParameterSetName='RandomNumberParameterSet', HelpUri='https://go.microsoft.com/fwlink/?LinkID=2235055', RemotingCapability='None')]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Microsoft.PowerShell.Utility\Get-SecureRandom', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName Microsoft.PowerShell.Utility\Get-SecureRandom
