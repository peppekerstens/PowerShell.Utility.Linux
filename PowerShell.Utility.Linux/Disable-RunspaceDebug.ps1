...
[CmdletBinding(DefaultParameterSetName='RunspaceNameParameterSet', HelpUri='https://go.microsoft.com/fwlink/?LinkId=2096924')]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Microsoft.PowerShell.Utility\Disable-RunspaceDebug', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName Microsoft.PowerShell.Utility\Disable-RunspaceDebug
