...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Microsoft.PowerShell.Utility\Get-Culture', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName Microsoft.PowerShell.Utility\Get-Culture
